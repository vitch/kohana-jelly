...
class Jelly_Core_Validation_Exception extends Kohana_Exception {
	...
	/**
	 * The alias of the main Jelly model this exception was created for
	 * @var string
	 */
	 ...
	 * @return Jelly_Validation_Exception
	 */
	public function merge($alias, Jelly_Validation_Exception $object, $has_many = FALSE)
	{
		if ($has_many === TRUE)
		{
			// This is most likely a has_many relationship
	 ...
	 *
	 *     // Will load Model_User errors from messages/jelly-validation/user.php
	 *     $e->errors('jelly-validation');
	 *
